    ...
    >
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 py-4 text-white">
        <h1 className="text-xl font-bold">
          CINEMATIC <span className="text-red-500">STUDIO</span>
        </h1>
        ...
        <button className="bg-red-600 px-6 py-3 rounded-lg hidden md:block">
          Get Started
        </button>
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center text-center px-4 text-white">
        ...
        <p className="text-gray-300 max-w-xl mt-6 hover:text-white transition-colors">
          We create cinematic visuals and powerful storytelling
          for brands and films.
        </p>

        <div className="mt-8 flex gap-4">
          <button className="bg-red-600 px-6 py-3 rounded-lg hover:bg-green-700 transition-all hover:scale-105">
            View Work
          </button>
